#!/usr/bin/python3
"""Define storage engine using the MySQL database and Import modules
"""
...
class DBStorage:
    """This class manages the MySQL storage using SQLAlchemy
    ...
    def all(self, cls=None):
        """Query and return all the  objects by class/generally
    ...
    def new(self, obj):
        """Adda object to current database session
        """
